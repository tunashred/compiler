...
typedef enum {
    ...
    // delimiters
    SINGLE_QUOTE = 100, DOUBLE_QUOTE, COMMA, COLON, SEMICOLON,
    L_ROUND_PAR, R_ROUND_PAR, L_SQUARE_PAR, R_SQUARE_PAR, L_BRACKET, R_BRACKET,
    // operators
    ADD = 200, SUB, INC, DEC, MUL, DIV,
    BITWISE_AND = 300, BITWISE_OR, BITWISE_XOR, BITWISE_NOT,
    LOGICAL_AND = 400, LOGICAL_OR, LOGICAL_NOT, ASSIGN, EQUAL, NOT_EQ, LESS, LESS_EQ, GREATER, GREATER_EQ,
    FUNC_RET_OP,
    // literals
    LITERAL_INT = 500, LITERAL_FLOAT, LITERAL_CHAR, LITERAL_CHARRAY,
    // non-tokens
